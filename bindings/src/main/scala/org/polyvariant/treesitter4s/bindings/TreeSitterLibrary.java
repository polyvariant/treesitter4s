...
public interface TreeSitterLibrary extends Library {
	...
	Tree ts_parser_parse_string_encoding(Parser parser, Pointer oldTree, byte[] string, long length, int encoding);
	...
	Node.ByValue ts_node_child(Node node, long index);
